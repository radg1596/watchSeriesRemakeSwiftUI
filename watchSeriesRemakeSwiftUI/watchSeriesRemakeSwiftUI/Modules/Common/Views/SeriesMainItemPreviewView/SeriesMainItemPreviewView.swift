...
struct SeriesMainItemPreviewView: View {
    ...
    var buttonsActionSectionView: some View {
        SeriesTripleActionBarView(leftButtonTitle: Localizables.generalTextMyList.localize,
                                  leftButtonSysImageName: constants.leftButtonImageName,
                                  onClickLeftButton: {
            // Action here...
        },
                                  middleButtonTitle: Localizables.generalTextPlayText.localize,
                                  middleButtonSysImageName: constants.middleButtonImageName,
                                  onClickMiddleButton: {
            // Action here...
        },
                                  rightButtonTitle: Localizables.generalTextInfoText.localize,
